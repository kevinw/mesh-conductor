...
public class ProceduralCylinder : MonoBehaviour {
	...
	void Update () {
		...
		float bottomRadius1 = info.bottomRadius1;
		float bottomRadius2 = info.bottomRadius2;
		float topRadius1 = info.topRadius1;
		float topRadius2 = info.topRadius2;
		float height = info.height;
		int nbSides = info.nbSides;
		...
		int nbVerticesCap = info.nbSides * 2 + 2;
