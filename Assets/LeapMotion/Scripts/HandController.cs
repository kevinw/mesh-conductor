...
public class HandController : MonoBehaviour {
  ...
  List<HandModel> _hand_models;

  public IList<HandModel> HandModels { 
	  get {
		  if (_hand_models == null)
			  _hand_models = new List<HandModel>();
		  else
			  _hand_models.Clear();
		  _hand_models.AddRange(hand_graphics_.Values);
		  return _hand_models;
	  }
  }
